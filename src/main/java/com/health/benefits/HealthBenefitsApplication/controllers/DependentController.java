...
//	}
    ...
    public ResponseEntity<DependentsDTO> getDependentById(@PathVariable("dependent_id") UUID id) {
...
@PutMapping(path="/{id}")
public ResponseEntity<DependentsDTO> fullUpdateDependent(@PathVariable("id") UUID id, @RequestBody DependentsDTO dependentsDto){
...
public ResponseEntity<DependentsDTO> partialUpdate(@PathVariable("id") UUID id, @RequestBody DependentsDTO dependentDto){
	...
	return new ResponseEntity<>(dependentsMapper.mapTo(updatedDependent), HttpStatus.OK);
 	...
 	public ResponseEntity<DependentsDTO> deleteDependent(@PathVariable("id") UUID id) {
